...
import './css/styles.css'; // Usaremos um CSS dedicado
  ...
  return (
    <header className="header">
      ...
      <nav className="nav nav-center">
        <NavLink to="/employee/dashboard" className="nav_link">Meus Agendamentos</NavLink>
      </nav>
        ...
        <div className="profile-icon-container">
          ...
          {showDropdown && (
            <div className="dropdown-menu">
              {/* No futuro, pode ter uma página de perfil para o funcionário */}
